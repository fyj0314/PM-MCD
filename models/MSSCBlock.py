...
class PSAModule(nn.Module):
    ...
    def __init__(self, inplans, planes, conv_kernels=[3, 5, 7, 9], stride=1, conv_groups=[1, 4, 8, 16]):
        ...
        self.cam = ChannelAttentionModule(planes // 4)
    ...
    def forward(self, x):
        ...
        x_cam = torch.cat((x1_cam, x2_cam, x3_cam, x4_cam), dim=1)
        attention_vectors = x_cam.view(batch_size, 4, self.split_channel, 1, 1)
